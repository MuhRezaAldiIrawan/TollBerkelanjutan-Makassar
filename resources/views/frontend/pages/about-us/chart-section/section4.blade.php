<style>
    ...
    <div class="row m-0 justify-content-between" style=" grid-gap: 8px;">
        <div class=" col p-4 bg-white rounded shadow-sm">
                ...
                <thead>
                    <tr>
                        ...
                        @foreach ($chart4->getGraphData('gate', 'curr', $currentYear, $currentMonthNumber) as $gate)
                            <th scope="col-1" style="font-size: 12px;"class="test">{{ $gate }}</th>
                        @endforeach
                    </tr>
                </thead>
                <tbody>

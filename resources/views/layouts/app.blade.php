...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('apexnew/app-assets/img/ico/favicon.ico')}}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('apexnew/app-assets/img/ico/favicon-32.png')}}">
    ...
    <link rel="stylesheet" href="{{ asset('apexnew/app-assets/vendors/css/swiper.min.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN APEX CSS-->

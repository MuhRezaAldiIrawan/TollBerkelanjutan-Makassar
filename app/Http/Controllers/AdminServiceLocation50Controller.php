<?php namespace App\Http\Controllers;
	...
	class AdminServiceLocation50Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kategori","name"=>"kategori","join"=>"kategori,kategori"];
			...
			$this->form[] = ['label'=>'Kategori','name'=>'kategori','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'kategori,kategori'];
			...
			//$this->form[] = ["label"=>"Maps","name"=>"maps","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];

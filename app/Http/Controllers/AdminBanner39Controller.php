<?php namespace App\Http\Controllers;
	...
	class AdminBanner39Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Menu","name"=>"menu","join"=>"menu,menu"];
			...
			$this->form[] = ['label'=>'Menu','name'=>'menu','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'menu,menu'];
			$this->form[] = ['label'=>'Status','name'=>'active','type'=>'radio','validation'=>'required','width'=>'col-sm-9','datatable'=>'active,name'];
			...
			//$this->form[] = ["label"=>"Menu","name"=>"menu","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];

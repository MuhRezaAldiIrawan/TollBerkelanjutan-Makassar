<?php namespace App\Http\Controllers;
	...
	class AdminUserstrafficController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->form[] = ["label"=>"Guest","name"=>"id_guest","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"guest,id"];

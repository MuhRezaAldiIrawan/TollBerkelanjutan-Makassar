<?php namespace App\Http\Controllers;
	...
	class AdminUsers12Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Role Id","name"=>"role_id","join"=>"role,id"];
			...
			$this->form[] = ['label'=>'Password','name'=>'password','type'=>'password','validation'=>'min:3|max:32','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			$this->form[] = ['label'=>'Role Id','name'=>'role_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','help'=>'Minimum 5 characters. Please leave empty if you did not change the password.'];
			...
			//$this->form[] = ["label"=>"Email Verified At","name"=>"email_verified_at","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			...
			//$this->form[] = ["label"=>"Role Id","name"=>"role_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"role,id"];
			# OLD END FORM

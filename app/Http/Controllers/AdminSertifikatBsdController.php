<?php namespace App\Http\Controllers;
	...
	class AdminSertifikatBsdController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Active','name'=>'active','type'=>'radio','validation'=>'required|integer|min:0','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only','datatable'=>'active,name'];
